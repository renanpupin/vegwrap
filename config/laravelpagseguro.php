...
return [
    ...
    'credentials' => [//INFORME AS CREDENCIAIS PADRÕES DE SUA LOJA, MAS PORDERÁ SER ALTERADA EM RUNTIME
        'email' => env('PAGSEGURO_APPEMAIL'),
        'token' => env('PAGSEGURO_APPKEY'),
    ],
    ...
    'routes' => [
        ...
        'notification' => [
            'callback' => ['HomeController', 'notificacao'], // Callable callback to Notification function (notificationInfo) : void {}
