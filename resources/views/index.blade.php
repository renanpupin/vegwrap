...
<section id="header">
    <header class="major brand-logo">
        ...
        {{--<h1>Veg Wrap</h1>--}}
        <img class="logo-image" src="assets/images/logo_vegwrap.png">
    ...
    <div class="container">
        <ul class="actions">
            ...
            <li><a href="/login" class="button special scrolly btnPedido">Fazer Pedido</a></li>
        </ul>
    </div>
